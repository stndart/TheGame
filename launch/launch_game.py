...
def write_config(game_path: Path, launch_token: str, server_ip: str) -> None:
    lines = [
        ...
        f"m_lang={LANGUAGE}",
        f"m_enableDiscordPresence={_flag(ENABLE_DISCORD_PRESENCE)}",
        f"m_enableExclusiveFullscreen={_flag(ENABLE_EXCLUSIVE_FULLSCREEN)}",
        f"m_showFpsCounter={_flag(SHOW_INGAME_FPS_COUNTER)}",
    ]
