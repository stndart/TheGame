...
// Method bodies: ProudNet/FastSocket.hpp, ConnectionNode.hpp, GrowableBuffer.hpp.
...
// TCP framing (Proud::CTcpLayerMessageExtractor::Extract / send framer -
...
constexpr std::uintptr_t kRecvGrowable =
    0x8C;                                   // embedded Proud::GrowableBuffer @ +140
...
struct RecvBuffer : GrowableBuffer {
