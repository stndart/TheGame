...
// Confirmed by IDA 2026-05-29 - see docs/plans/proudnet-rmi-server-plan.md
// "Game RMI proxy map".
//
...
//   sub_A0B290  __userpurge(a1=eax)   (msg, len)               -- id =
//   *(u16*)msg
...
//
// Both have the plain non-SEH prologue 55 8B EC 83 E4 F8 (push ebp; mov
// ebp,esp; and esp,-8); steal 6 bytes, resume at target+6. Stack-arg offsets
...
// sub_A0B290: msg (a2) at entry [esp+0x04], len at [esp+0x08]; rmi id =
// *(u16*)msg.
...
HookStub g_target_pn_game_rmi_send = {
    0x65AEA0,
    (uint32_t)(uintptr_t)hook_pn_game_rmi_send,
    "hook_pn_game_rmi_send",
    {0},
    false,
    0x65AEA6,
};
...
HookStub g_target_pn_rmi_floor = {
    0xA0B290,
    (uint32_t)(uintptr_t)hook_pn_rmi_floor,
    "hook_pn_rmi_floor",
    {0},
    false,
    0xA0B296,
