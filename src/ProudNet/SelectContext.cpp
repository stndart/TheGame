...
constexpr std::uintptr_t kFastSocketHandleOff = Proud::FastSocketLayout::kSocket;
constexpr std::uintptr_t kReadFdSetOff = Proud::SelectLayout::kReadFdSet;
constexpr std::uintptr_t kExceptFdSetOff = Proud::SelectLayout::kExceptFdSet;

} // namespace

char Proud::CSelectContext::poll(void *fast_socket_ctx, std::uint32_t *out) {
