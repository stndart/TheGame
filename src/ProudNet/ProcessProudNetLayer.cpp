...
void restore_read_offset(void *received_msg, int offset_div8) {
  const auto fn = reinterpret_cast<RestoreReadOffsetFn>(
      game_va(static_cast<std::uint32_t>(Proud::Rva::kMessageRestoreReadOffset)));
...
bool is_from_remote_client_peer(void *worker, void *msg) {
  const auto fn = reinterpret_cast<IsFromRemoteClientPeerFn>(game_va(
      static_cast<std::uint32_t>(Proud::Rva::kIsFromRemoteClientPeer)));
...
bool dispatch_compressed_or_encrypted(void *worker, void *wstr, void *msg,
  ...
  const bool processed =
      Proud::ProcessMessageProudNetLayer(worker, wstr, stack_mem);
  dtor(stack_mem);
  return processed;
}
...
bool Proud::ProcessMessageProudNetLayer(void *worker, void *wstr_body,
                                    void *received_msg) {
  ...
  const auto message_read = reinterpret_cast<MessageReadFn>(game_va(
      static_cast<std::uint32_t>(Proud::Rva::kMessageRead)));
  if (!message_read(msg_stream, &type_raw)) {
    restore_read_offset(received_msg, saved_offset_div8);
    return false;
  }

  const auto type = static_cast<Proud::MessageType::Type>(
  ...
  case Proud::MessageType::Type::UserMessage: {
    unsigned char out_flag = 0;
    const auto fn = reinterpret_cast<WorkerUserMessageFn>(game_va(
        static_cast<std::uint32_t>(Proud::Rva::kHandlerUserMessage)));
    fn(worker, received_msg, &out_flag);
    (void)out_flag;
  ...
  case Proud::MessageType::Type::Hla:
    message_processed =
        dispatch_with_peer_guard(worker, received_msg, Proud::Rva::kHandlerHla);
    break;
  case Proud::MessageType::Type::ConnectServerTimedout:
    // TODO: OutputDebugStringW before handler (sub_D653B0 case 4).
    message_processed = dispatch_with_peer_guard(
        worker, received_msg, Proud::Rva::kHandlerConnectServerTimedout);
    break;
  case Proud::MessageType::Type::GameNotify6:
    message_processed = dispatch_with_peer_guard(worker, received_msg,
                                                 Proud::Rva::kHandlerGameNotify6);
    break;
  case Proud::MessageType::Type::GameNotify8:
    message_processed = dispatch_with_peer_guard(worker, received_msg,
                                                 Proud::Rva::kHandlerGameNotify8);
    break;
  case Proud::MessageType::Type::GameNotify9:
    message_processed = dispatch_with_peer_guard(worker, received_msg,
                                                 Proud::Rva::kHandlerGameNotify9);
    break;
  case Proud::MessageType::Type::GameNotify10:
    message_processed = dispatch_with_peer_guard(worker, received_msg,
                                                 Proud::Rva::kHandlerGameNotify10);
    break;
  case Proud::MessageType::Type::NotifyProtocolVersionMismatch:
    message_processed = dispatch_with_peer_guard(
        worker, received_msg, Proud::Rva::kHandlerNotifyProtocolVersionMismatch);
    break;
  case Proud::MessageType::Type::NotifyServerConnectSuccess:
    message_processed = dispatch_with_peer_guard(
        worker, received_msg, Proud::Rva::kHandlerNotifyServerConnectSuccess);
    break;
  case Proud::MessageType::Type::NotifyAutoConnectionRecoverySuccess:
    message_processed = dispatch_with_peer_guard(
        worker, received_msg,
        Proud::Rva::kHandlerNotifyAutoConnectionRecoverySuccess);
    break;
  case Proud::MessageType::Type::RequestStartServerHolepunch:
    message_processed = dispatch_with_peer_guard(
        worker, received_msg, Proud::Rva::kHandlerRequestStartServerHolepunch);
    break;
  case Proud::MessageType::Type::ServerHolepunchAck:
    message_processed =
        dispatch_worker_wstr_msg(worker, wstr_body, received_msg,
                                 Proud::Rva::kHandlerServerHolepunchAck);
    break;
  case Proud::MessageType::Type::GameNotify24:
    message_processed =
        dispatch_with_peer_guard(worker, received_msg, Proud::Rva::kHandlerGameNotify24);
    break;
  case Proud::MessageType::Type::GameNotify25:
    if (!is_from_remote_client_peer(worker, received_msg)) {
      dispatch_worker_wstr_msg(worker, wstr_body, received_msg,
                               Proud::Rva::kHandlerGameNotify25);
    }
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify26:
    if (!is_from_remote_client_peer(worker, received_msg)) {
      dispatch_worker_wstr_msg(worker, wstr_body, received_msg,
                               Proud::Rva::kHandlerGameNotify26);
    }
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify29:
    message_processed =
        dispatch_with_peer_guard(worker, received_msg, Proud::Rva::kHandlerGameNotify29);
    break;
  case Proud::MessageType::Type::GameNotify31:
    call_worker_msg_handler(worker, Proud::Rva::kHandlerGameNotify31, received_msg);
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify32:
    call_worker_msg_handler(worker, Proud::Rva::kHandlerGameNotify32, received_msg);
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify33:
    call_worker_msg_handler(worker, Proud::Rva::kHandlerGameNotify33, received_msg);
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify34:
    call_worker_msg_handler(worker, Proud::Rva::kHandlerGameNotify34, received_msg);
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify35:
    if (!is_from_remote_client_peer(worker, received_msg)) {
      dispatch_worker_wstr_msg(worker, wstr_body, received_msg,
                               Proud::Rva::kHandlerGameNotify35);
    }
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify36:
    dispatch_worker_wstr_msg(worker, wstr_body, received_msg,
                             Proud::Rva::kHandlerGameNotify36);
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameCompressed37:
  case Proud::MessageType::Type::GameCompressed38:
  case Proud::MessageType::Type::GameEncrypted39:
    return dispatch_compressed_or_encrypted(worker, wstr_body, received_msg,
                                            type);
  case Proud::MessageType::Type::GameNotify40:
    dispatch_worker_wstr_msg(worker, wstr_body, received_msg,
                             Proud::Rva::kHandlerGameNotify40);
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify41:
    call_worker_msg_handler(worker, Proud::Rva::kHandlerGameNotify41, received_msg);
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify49:
    call_worker_msg_handler(worker, Proud::Rva::kHandlerGameNotify49, received_msg);
    message_processed = true;
    break;
  case Proud::MessageType::Type::GameNotify50:
    call_worker_msg_handler(worker, Proud::Rva::kHandlerGameNotify50, received_msg);
    message_processed = true;
    break;
  default:
    if (Proud::MessageType::is_game_noop(type)) {
      message_processed = true;
    }
    break;
  }
